...
were compared using indepenten-samples two-way ANOVAs. As in Studies 1a and 1b,
there was a manipulation check asking the parcitipants to rate to which extent
...
($F(`r anova_active[trimws(rownames(anova_active)) == 'agency', 'Df']`,
`r anova_active[trimws(rownames(anova_active)) == 'Residuals', 'Df']`) =
`r anova_active[trimws(rownames(anova_active)) == 'agency', 'F value']`,
p = `r anova_active[trimws(rownames(anova_active)) == 'agency', 'Pr(>F)']`$),
a significant effect of assigned level of blame
($F(`r anova_active[trimws(rownames(anova_active)) == 'blame_level', 'Df']`,
`r anova_active[trimws(rownames(anova_active)) == 'Residuals', 'Df']`) =
`r anova_active[trimws(rownames(anova_active)) == 'blame_level', 'F value']`,
p =
`r anova_active[trimws(rownames(anova_active)) == 'blame_level', 'Pr(>F)']`$),
and a nonsignificant interaction
($F(`r anova_active[trimws(rownames(anova_active)) ==
'agency:blame_level', 'Df']`,
`r anova_active[trimws(rownames(anova_active)) == 'Residuals', 'Df']`) =
`r anova_active[trimws(rownames(anova_active)) ==
'agency:blame_level', 'F value']`,
p = `r anova_active[trimws(rownames(anova_active)) ==
'agency:blame_level', 'Pr(>F)']`$),

Comparing the participants' assigned fines, we find
a nonsignificant effect of agency
($F(`r anova_fine[trimws(rownames(anova_fine)) == 'agency', 'Df']`,
`r anova_fine[trimws(rownames(anova_fine)) == 'Residuals', 'Df']`) =
`r anova_fine[trimws(rownames(anova_fine)) == 'agency', 'F value']`,
p = `r anova_fine[trimws(rownames(anova_fine)) == 'agency', 'Pr(>F)']`$),
a significant effect of assigned level of blame
($F(`r anova_fine[trimws(rownames(anova_fine)) == 'blame_level', 'Df']`,
`r anova_fine[trimws(rownames(anova_fine)) == 'Residuals', 'Df']`) =
`r anova_fine[trimws(rownames(anova_fine)) == 'blame_level', 'F value']`,
p =
`r anova_fine[trimws(rownames(anova_fine)) == 'blame_level', 'Pr(>F)']`$),
and a nonsignificant interaction
($F(`r anova_fine[trimws(rownames(anova_fine)) ==
'agency:blame_level', 'Df']`,
`r anova_fine[trimws(rownames(anova_fine)) == 'Residuals', 'Df']`) =
`r anova_fine[trimws(rownames(anova_fine)) ==
'agency:blame_level', 'F value']`,
p = `r anova_fine[trimws(rownames(anova_fine)) ==
'agency:blame_level', 'Pr(>F)']`$),
