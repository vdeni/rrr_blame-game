...
financial fine greater than `r .financial_fine_lim_hrk` HRK. None of the
...
of blame or the assessment of the financial fine. These exclusions left us
...
In total, `r .n_start` people decided to participate in the study. As was
stated earlier, we have decided to exclude participants who have entered a
financial fine greater than `r .financial_fine_lim_usd` USD. One of the
